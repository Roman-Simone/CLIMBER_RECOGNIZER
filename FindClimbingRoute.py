...
dim_y_window = 800
width_form = 270
path_img = "Media/img_lead_2.jpg" #"Media/img_lead_1.jpg"  #"Media/img_lead_2.jpg"  #"Media/img_lead_3.jpg"
start_x = -1
start_y = -1
finish_x = -1
finish_y = -1
...
def button_findRoute(canvas_image, tk_image):
    ...
    lower_range = (int(h-10), 50, 50) # lower range of red color in HSV
    upper_range = (int(h+10), 255, 255) # upper range of red color in HSV
