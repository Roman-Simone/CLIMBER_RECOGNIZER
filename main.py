...
def button_cropIMG(canvas_image, tk_image):
...
def on_resize(event, canvas_image, tk_image):
...
def init_window(window):
    ...
    window.bind("<Configure>", lambda event: on_resize(event, canvas_image, tk_image))
    ...
    button1 = tk.Button(frame_btn, text="CROP IMAGE", command=lambda: button_cropIMG(canvas_image, tk_image))
    button1.pack()
